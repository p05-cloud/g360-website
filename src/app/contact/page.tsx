...
const faqs = [
  {
    ...
    answer:
      "Our products are available through our authorized dealers and distribution network. For availability in your area, fill out the contact form on this page or reach out to us on Instagram. Our team will connect you with the nearest distributor.",
  },
  {
...
export default function ContactPage() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // Show success state (form data can be integrated with a backend later)
    setSubmitted(true);
  };
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="max-w-md text-sm text-gray-400">
                    Your inquiry has been sent. Our team will get back to you
                    shortly. You can also reach us at{" "}
